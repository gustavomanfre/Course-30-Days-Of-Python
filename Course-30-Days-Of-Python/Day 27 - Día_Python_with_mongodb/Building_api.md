...
python# PASO 1: Conexión (no hay datos aún)
client = pymongo.MongoClient(MONGODB_URI)
...
python# 1. Abres la app de delivery (conexión)
client = pymongo.MongoClient(MONGODB_URI)
