...
=======
    #  [ VER # FUNCIONES DE ORDEN SUPERIOR..pdf]
>>>>>>> d871da3baac76396eff9cc9854737691950de2c1
...
# EJEMPLO 3 - [VER FUNCIONES COMO VALOR DE RETORNO.pdf]
def square(x):
    return x * x
...
Para alcanzar cada valor, Python aplica un algoritmo de búsqueda llamado LEGB. 
...
Python permite que una función anidada acceda al ámbito externo de la función de cierre. Esto se conoce como cierre. Echemos un vistazo a cómo funcionan los cierres en Python. En Python, el cierre se crea anidando una función dentro de otra función de encapsulación y luego devolviendo la función interna. Vea el ejemplo a continuación.
